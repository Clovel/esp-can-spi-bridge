...
FTD2XX_API
FT_STATUS WINAPI FT_Open(int        deviceNumber,
                         FT_HANDLE  *pHandle);
...
FTD2XX_API
FT_STATUS WINAPI FT_ListDevices(PVOID   pArg1,
                                PVOID   pArg2,
                                DWORD   Flags);

FTD2XX_API
FT_STATUS FT_SetVIDPID(DWORD    dwVID,
                       DWORD    dwPID);

FTD2XX_API
FT_STATUS FT_GetVIDPID(DWORD    *pdwVID,
                       DWORD    *pdwPID);
...
FTD2XX_API
FT_STATUS WINAPI FT_SetBaudRate(FT_HANDLE   ftHandle,
                                ULONG       BaudRate);

FTD2XX_API
FT_STATUS WINAPI FT_SetDivisor(FT_HANDLE    ftHandle,
                               USHORT       Divisor);
...
FTD2XX_API
FT_STATUS WINAPI FT_Purge(FT_HANDLE ftHandle,
                          ULONG     Mask);
...
FTD2XX_API
FT_STATUS WINAPI FT_SetWaitMask(FT_HANDLE   ftHandle,
                                DWORD       Mask);
...
FTD2XX_API
FT_STATUS WINAPI FT_EE_Read(FT_HANDLE           ftHandle,
                            PFT_PROGRAM_DATA    pData);
...
FTD2XX_API
FT_STATUS WINAPI FT_EE_UASize(FT_HANDLE ftHandle,
                              LPDWORD   lpdwSize);
...
FTD2XX_API
FT_STATUS WINAPI FT_GetBitMode(FT_HANDLE    ftHandle,
                               PUCHAR       pucMode);
...
FTD2XX_API
FT_HANDLE WINAPI FT_W32_CreateFile(LPCSTR                   lpszName,
                                   DWORD                    dwAccess,
                                   DWORD                    dwShareMode,
...
FTD2XX_API
BOOL WINAPI FT_W32_EscapeCommFunction(FT_HANDLE ftHandle,
                                      DWORD     dwFunc);
...
FTD2XX_API
BOOL WINAPI FT_W32_GetCommState(FT_HANDLE   ftHandle,
                                LPFTDCB     lpftDcb);
...
FTD2XX_API
BOOL WINAPI FT_W32_PurgeComm(FT_HANDLE  ftHandle,
                             DWORD      dwMask);
...
FTD2XX_API
BOOL WINAPI FT_W32_SetCommMask(FT_HANDLE    ftHandle,
                               ULONG        ulEventMask);

FTD2XX_API
BOOL WINAPI FT_W32_SetCommState(FT_HANDLE   ftHandle,
                                LPFTDCB     lpftDcb);
